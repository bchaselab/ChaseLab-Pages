...
```shell
# On MacOS, open iterm. On Windows, open Anaconda cmd
...
```shell
# Example
$ rclone --drive-shared-with-me copy drive:may20/may20_catcat_10-08-2020 ./
```
...
<embed src="../src/html/cat_swinging.html" width="350px" height="500px" />